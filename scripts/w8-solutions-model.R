...
# Exercises --------------------------------------------------------------------
# 1. Build up a binomial model in the same way we did last week for the binary 
# model. This time, include the goodness of fit. Perform a sensitivity analysis.

# Solution:
# I included the continuous effects of average seed mass and average seed depth,
# and the fixed effect of herbicide.

# I tested the goodness of fit and got a Bayesian p-value of 0!
# So I also included an observation-level random effect of tray_id.

# The overlap0 columns read TRUE for the effects of both seed_mass and 
# seed_depth, so I removed them from the model.

# Note that the effect of seed mass overlapped 0 for this binomial model, but 
# did not last week for our binary model! Taking the average when we aggregated 
# our data likely cost us some information value.

# After adding in the random effect of tray_id, I got a much better goodness of 
# fit, with the point cloud overlapping the 1:1 line.

# TODO: finish sensitivity analysis.